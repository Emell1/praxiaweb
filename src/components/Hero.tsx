      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="body-lg text-white/70 mb-10 max-w-2xl mx-auto">
            Trabajamos con universidades y empresas de educación para ordenar cómo operan: los procesos que frenan el crecimiento, los equipos que no rinden lo que podrían, y la distancia entre lo que se planifica y lo que pasa en el día a día.
          </p>
