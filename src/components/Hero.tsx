    ...
    <section className="section-padding min-h-[90vh] flex items-center relative overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt="Fondo de trabajo con laptop"
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <span className="inline-flex items-center px-4 py-2 rounded-full bg-accent/50 text-sm font-medium mb-6">
            <AnimatedLogo /> <span className="mx-1 text-blue-600">|</span> Optimización Estratégica de Procesos
          </span>
          <h1 className="heading-xl mb-6 max-w-4xl mx-auto">
            Transformamos procesos en{" "}
            <span className="text-blue-600">ventajas competitivas</span>
          </h1>
